        ...
        <div className=''>
            ...
            {availableProps.length === 0 ? (
                ...
                availableProps.map((room) => (
                    <div key={room._id} className='border-2 '>
                        <h3>{room.title}</h3>
                        <p><strong>Price:</strong> ₹{room.price.toLocaleString()}</p>
                        <p><strong>Location:</strong> {room.street}, {room.city}, {room.state}</p>
            ...
            {bookedProps.length === 0 ? (
                ...
                bookedProps.map((booking) => (
                    <div key={booking._id} style={{ border: '1px solid red', padding: '1rem', marginBottom: '1rem' }}>
                        <h3>{booking.property?.title}</h3>
                        <p><strong>Price:</strong> ₹{booking.property?.price.toLocaleString()}</p>
                        <p><strong>Location:</strong> {booking.property?.street}, {booking.property?.city}, {booking.property?.state}</p>
